...
//Defining some margins for charts 
var svgWidth = 960;
var svgHeight = 500;
...
var svg = d3
  .select(".chart").select("#scatter").append("div").classed("chart",true)
  .append("svg")
  .attr("width", svgWidth)
...
// Function used for updating circles group with tool tip 
...
//Call CSV data and Parse through it
...
// Append data to the circles plots
